...
Waiver.create! do |w|
  ...
  w.content = "**Acknowledgements**\n\nYou acknowledge and accept that climbing/bouldering is a dangerous recreational activity with obvious risks. You are participating at your own risk.\n\nBouldering Gym provides a safe environment to all participants and utilises state of the art equipment to ensure the safety of all its members. However, as bouldering is inherently a dangerous recreational activity, it is a requirement that all participants sign the waiver below.\n\nParticipants under the age of 18 must have their parent or legal guardian fill out and sign the waiver below.\n\nBouldering may involve incidental and significant risks which may cause physical or psychological injuries and in extreme circumstances, death.\n\nThis waiver excludes any liability for the personal injury which might be incurred by Bouldering Gym, its employees, agents and representatives arising out of your voluntary participation in the activities offered at Bouldering Gym.\n\nBy completing this form, you will accept the terms and conditions and will be agreeing to exclude and limit Bouldering Gym’s liability.\n\nYou are not obligated to sign or waive the liability under this form, however, should you not agree to this waiver, Bouldering Gym may refuse to provide you with its services and access to the premises.\n\n**Waiver**\n\nI have been advised of the risks and dangers of bouldering and wish to participate at my own risk of injury.\n\nI understand that bouldering and the use of the equipment at Bouldering Gym could result in physical and psychological injuries and in extreme circumstances, death.\n\nI do not suffer from any medical condition or any other condition that may affect my ability to participate in bouldering safely. I assume the risk of injury to my health and safety.\n\nI agree not to participate in activities whilst under the influence of drugs of alcohol.\n\nI understand and accept the responsibility to review and comply with the rules and regulations, including any changes to these, at Bouldering Gym.\n\nI am aware that this waiver is ongoing and will continue to apply to all future occasions I participate with Bouldering Gym.\n\nI am at least 18 years of age and have legal capacity to sign this form or I am a parent or legal guardian responsible for the participant who is under the age of 18 years old.\n\nI hereby indemnify and release Bouldering Gym, its directors, its employees, agents and representatives involved in my participation of the recreational activities offered from any legal costs, demand, action or claim for compensation whether for personal injury or damage to property arising from my participation of the activities."
...
50.times do |i|
  ...
  user.create_user_profile!({ date_of_birth: Faker::Date.between(from: 50.years.ago, to: Date.today),
  ...
  user.create_user_address!({ city: Faker::Address.city,
                              country: 'Australia',
  ...
  n = rand(1..3)
  user.check_ins.create! if n == 1

  user.create_user_photo!
  user.user_photo.image.attach({
                                 io: image_fetcher,
